...
protected:
  RC init(const IndexMeta &index_meta, const FieldMeta &field_meta, std::vector<FieldMeta> other_field_meta = {});

protected:
  IndexMeta index_meta_;
  FieldMeta field_meta_;  /// 当前实现考虑多个字段的索引
  std::vector<FieldMeta> other_field_meta_;
};
